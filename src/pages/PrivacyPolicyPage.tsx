      ...
      <Container>
        <div className="mx-auto max-w-3xl">
          <div className="flex flex-wrap items-center gap-2">
            <Badge className="bg-slate-900/5 text-slate-700 dark:bg-white/10 dark:text-slate-200">
              Privacy Policy
            </Badge>
          ...
          <p className="mt-3 text-slate-600 dark:text-slate-300">
            This privacy policy applies to the {site.appName} app (hereby
            referred to as &quot;Application&quot;) for mobile devices that was
            created by {site.companyName} (hereby referred to as &quot;Service
          ...
          <div className="prose prose-slate mt-10 max-w-none dark:prose-invert">
            ...
            <p>
              ...
              {site.supportEmail}) so that they will be able to take the
              necessary actions.
            </p>
